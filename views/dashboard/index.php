 ...
 * @var $reset_queue \JustCoded\WP\ImageOptimizer\components\QueryVars .
 */
...
$dash_saving_size    = ( ! empty( $dash_stats->saving_size ) ? $dash_stats->saving_size : 0 );
$dash_saving_percent = ( ! empty( $dash_stats->percent ) ? $dash_stats->percent : 0 );
...
<div class="wrap jio-admin-page">
	...
	<div class="row">
		...
		<div class="column-l">
			<h2>Reset queue and Clear stats</h2>
			<form id="reset-form"
					nonce="<?php esc_attr_e( wp_create_nonce( 'options_nonce' ) ); ?>"
					action="<?php get_permalink(); ?>"
					method="post"
					onsubmit="return confirm( 'Are you sure?' );">
				<input type="hidden" name="reset-queue" value="1">
				<input id="submit-reset" type="submit" class="button button-primary" value="Reset">
			</form>
